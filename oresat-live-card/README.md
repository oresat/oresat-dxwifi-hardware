...
- OL hardware Git repository: <https://github.com/oresat/oresat-dxwifi-hardware>
- OL software Git reposity: <https://github.com/oresat/oresat-dxwifi-software>
- **TODO:** OL Design Notes + Design Review Notes
...
- There are 3 fiducials on the top layer and 3 on the bottom layer.
...
- There are components are on the top and bottom side of the board.
...
- SMPM connectors (J3, J4) should be hand-added according to the Oresat SOP.
